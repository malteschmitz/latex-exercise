...
\setgroup{\href{http://www.mlte.de/latex}{www.mlte.de/latex}}
...
\begin{document}
  ...
  \task[Mir ist das alles zu orange hier!][Farbe]\label{section-farbe}
    ...
    Im Dokument kann \lstinline{maincolor} als normale Farbe verwendet werden. Das hat den Vorteil, dass sich auch die eigenen Farbspielereien an den aktuellen Farbstil anpassen. Natürlich lässt sich der ganze Farbenspuk durch Setzen von \lstinline{maincolor=black} auch ganz abschalten.

    Darüber hinaus ist die Farbe der Uni Lübeck als \lstinline{uni-luebeck} definiert. Diese kann auch als Standardfarbe verwendet werden:
    \begin{lstlisting}[gobble=6]
  ...
  \task[Wir können auch Englisch][Sprachunterstützung]
  ...
  \task[des Informatikers liebste Aufgabe][Quellcode]
